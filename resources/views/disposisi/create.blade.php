        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Formulir Tambah Surat Disposisi</h6>
                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm @error('skpd') is-invalid @enderror" 
                                       name="skpd" value="{{ old('skpd') }}" required>
                                @error('skpd')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control form-control-sm @error('tgl_diterima') is-invalid @enderror" 
                                               name="tgl_diterima" value="{{ old('tgl_diterima') }}" required>
                                        @error('tgl_diterima')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm @error('no_agenda') is-invalid @enderror" 
                                               name="no_agenda" value="{{ old('no_agenda') }}" required>
                                        @error('no_agenda')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-sm @error('perihal') is-invalid @enderror" 
                                          name="perihal" rows="5" required>{{ old('perihal') }}</textarea>
                                @error('perihal')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
...
document.getElementById('btnKirim').addEventListener('click', function() {
    alert('Fungsi kirim akan ditambahkan nanti');
});
</script>
